...
Ein Randbefund zur Bibliothek: Von 1.099 Bausteinen im Standardzugriff sind genau **vier** vom Typ `mcp`. MCP-Konfigurationen sind fast immer projekt- und zugangsdatenspezifisch — hier ist wenig zu holen, und das ist kein Mangel des Katalogs.
