...
| Eigenes Werkzeug zur Auflösung, ob zwei Baustein-Namen dasselbe meinen | Unsere IDs sind `repo/typ/slug`, deterministisch und eindeutig; es gibt keine Identitätsunschärfe. <!-- lint:historisch --> Gemessen waren am 2026-08-07 von 54 Namensgruppen 45 gewollte Typ-Sätze desselben Repos, nur 9 repoübergreifend — der Altstand bleibt hier stehen, weil die Verwerfungsbegründung (deterministische IDs) unverändert gilt und nur der Katalog seither gewachsen ist. Nachtrag (2026-08-10): 66 Gruppen, 26 repoübergreifend, davon 20 wegen des am 2026-08-08 neu aufgenommenen Repos `anthropics__claude-plugins-official`; ohne dieses Repo gezählt liegt der Wert bei 10 — nahe an den ursprünglichen 9. Der Auflöser existiert bereits als `--type`. |
