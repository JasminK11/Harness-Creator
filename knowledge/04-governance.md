...
Empfohlene Reihenfolge: **M1, M2, M3, M6, M7, M9 und M10 sind erledigt** (M2 und M3 am 2026-08-10, siehe Nachtrag in 3.2; M9 am 2026-08-10, CLI- und Skill-Teil, siehe Zeile M9 oben), und M4, M5 und M8 sind in `knowledge/06` unter anderen Nummern aufgegangen und dort umgesetzt (Prüfregeln und Auswahlkriterien in `harness-build/SKILL.md`, `evals/routing.jsonl` samt `eval`-Subcommand, Bestätigung und Sichtprüfung vor dem Kopieren). Es bleibt **M11**.
