...
| ID | Beschreibung | KB |
|---|---|---:|
| `affaan-m__ecc/agent/a11y-architect` | Accessibility Architect specializing in WCAG 2.2 compliance for Web and Native platforms. Use PROACTIVELY when designing UI compo… | 7 |
...
| `msitarzewski__agency-agents/agent/senior-developer` | Premium implementation specialist - Masters Laravel/Livewire/FluxUI, advanced CSS, Three.js integration | 6 |
...
| `msitarzewski__agency-agents/agent/unity-architect` | Data-driven modularity specialist - Masters ScriptableObjects, decoupled systems, and single-responsibility component design for … | 12 |
| `msitarzewski__agency-agents/agent/uswds-developer` | Expert U.S. Web Design System frontend developer specializing in USWDS components and design tokens, accessible-by-default patter… | 24 |
| `msitarzewski__agency-agents/agent/ux-architect` | Technical architecture and UX specialist who provides developers with solid foundations, CSS systems, and clear implementation gu… | 15 |
...
| ID | Beschreibung | KB |
|---|---|---:|
| `affaan-m__ecc/command/gan-design` | Run a generator/evaluator design loop for frontend or visual work with bounded iterations and scoring. | 2 |
