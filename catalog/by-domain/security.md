...
| `anthropics__claude-plugins-official/agent/code-reviewer` | Reviews code for bugs, logic errors, security vulnerabilities, code quality issues, and adherence to project conventions, using c… | 3 |
...
| `anthropics__claude-plugins-official/command/modernize-harden` | Security vulnerability scan with a reviewable remediation patch — OWASP, CWE, CVE, secrets, injection | 7 |
